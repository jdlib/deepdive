...
/**
 * An Actual implementation for primitive char arrays.
 */
public class CharArrayActual<BACK,IMPL extends CharArrayActual<BACK,IMPL>> extends Actual<char[],BACK,IMPL> 
{
	/**
	 * Creates a CharArrayActual for the given value and owner.
	 * @param value the value
	 * @param back the owner
	 */
	public CharArrayActual(char[] value, BACK back)
	{
		super(value, back);
	}
	...
	public IMPL contains(char expected)
	{
	...
	public class ContainsActual
	{
		 ...
		 */
		@SuppressWarnings("boxing")
		public final ContainsActual allOf(char... elems)
		{
			List<Character> failing = null;
			for (char elem : elems)
			{
				if (!doesContain(elem))
				{
		 ...
		 */
		@SafeVarargs
		public final ContainsActual exactly(char... elems)
		{
		 ...
		 */
		@SuppressWarnings("boxing")
		public final ContainsActual noneOf(char... elems)
		{
			List<Character> failing = null;
			for (char elem : elems)
			{
		 ...
		 * @return this ContainsActual
		 */
		public final ContainsActual someOf(char... elems)
		{
			boolean found = false;
			for (char elem : elems)
			{
	 ...
	 * @return this
	 */
	public IMPL elem(int index, char expected)
	{
	...
	/**
	 * Returns a CharacterActual for the element at the given index.
	 * @param index the index
	 * @return the new actual
	 */
	public CharacterActual<IMPL,?> elem(int index)
	{
		return new CharacterActual<>(getElem(index), self());
	}
	 ...
	 * @return this
	 */
	public IMPL elems(char... expected)
	{
	 ...
	 */
	@NotMustBeOff
	protected char getElem(int index)
	{
		notMustBeOff();
	 ...
	 * @return contained?
	 */
	protected boolean doesContain(char elem)
	{
		for (char e : value())
		{
			if (elem == e)
