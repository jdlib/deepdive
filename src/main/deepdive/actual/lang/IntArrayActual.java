...
/**
 * An Actual implementation for primitive int arrays.
 */
public class IntArrayActual<BACK,IMPL extends IntArrayActual<BACK,IMPL>> extends Actual<int[],BACK,IMPL> 
{
	/**
	 * Creates a IntArrayActual for the given value and owner.
	 * @param value the value
	 * @param back the owner
	 */
	public IntArrayActual(int[] value, BACK back)
	{
		super(value, back);
	}
	...
	public IMPL contains(int expected)
	{
	...
	public class ContainsActual
	{
		 ...
		 */
		@SuppressWarnings("boxing")
		public final ContainsActual allOf(int... elems)
		{
			List<Integer> failing = null;
			for (int elem : elems)
			{
				if (!doesContain(elem))
				{
		 ...
		 */
		@SafeVarargs
		public final ContainsActual exactly(int... elems)
		{
		 ...
		 */
		@SuppressWarnings("boxing")
		public final ContainsActual noneOf(int... elems)
		{
			List<Integer> failing = null;
			for (int elem : elems)
			{
		 ...
		 * @return this ContainsActual
		 */
		public final ContainsActual someOf(int... elems)
		{
			boolean found = false;
			for (int elem : elems)
			{
	 ...
	 * @return this
	 */
	public IMPL elem(int index, int expected)
	{
	...
	/**
	 * Returns a IntegerActual for the element at the given index.
	 * @param index the index
	 * @return the new actual
	 */
	public IntegerActual<IMPL,?> elem(int index)
	{
		return new IntegerActual<>(getElem(index), self());
	}
	 ...
	 * @return this
	 */
	public IMPL elems(int... expected)
	{
	 ...
	 * @return contained?
	 */
	protected boolean doesContain(int elem)
	{
		for (int e : value())
		{
			if (elem == e)
