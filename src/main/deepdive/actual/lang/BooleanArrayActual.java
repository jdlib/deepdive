...
/**
 * An Actual implementation for primitive boolean arrays.
 */
public class BooleanArrayActual<BACK,IMPL extends BooleanArrayActual<BACK,IMPL>> extends Actual<boolean[],BACK,IMPL> 
{
	/**
	 * Creates a BooleanArrayActual for the given value and owner.
	 * @param value the value
	 * @param back the owner
	 */
	public BooleanArrayActual(boolean[] value, BACK back)
	{
		super(value, back);
	}
	...
	public IMPL contains(boolean expected)
	{
	...
	public class ContainsActual
	{
		 ...
		 */
		@SuppressWarnings("boxing")
		public final ContainsActual allOf(boolean... elems)
		{
			List<Boolean> failing = null;
		 ...
		 */
		@SafeVarargs
		public final ContainsActual exactly(boolean... elems)
		{
		 ...
		 */
		@SuppressWarnings("boxing")
		public final ContainsActual noneOf(boolean... elems)
		{
			List<Boolean> failing = null;
			for (boolean elem : elems)
			{
		 ...
		 * @return this ContainsActual
		 */
		public final ContainsActual someOf(boolean... elems)
		{
			boolean found = false;
			for (boolean elem : elems)
			{
	 ...
	 * @return this
	 */
	public IMPL elem(int index, boolean expected)
	{
	...
	/**
	 * Returns a BooleanActual for the element at the given index.
	 * @param index the index
	 * @return the new actual
	 */
	public BooleanActual<IMPL,?> elem(int index)
	{
		return new BooleanActual<>(getElem(index), self());
	}
	 ...
	 * @return this
	 */
	public IMPL elems(boolean... expected)
	{
	 ...
	 */
	@NotMustBeOff
	protected boolean getElem(int index)
	{
		notMustBeOff();
	 ...
	 * @return contained?
	 */
	protected boolean doesContain(boolean elem)
	{
		for (boolean e : value())
		{
			if (elem == e)
