...
/**
 * An Actual implementation for primitive short arrays.
 */
public class ShortArrayActual<BACK,IMPL extends ShortArrayActual<BACK,IMPL>> extends Actual<short[],BACK,IMPL> 
{
	/**
	 * Creates a ShortArrayActual for the given value and owner.
	 * @param value the value
	 * @param back the owner
	 */
	public ShortArrayActual(short[] value, BACK back)
	{
		super(value, back);
	}
	...
	public IMPL contains(short expected)
	{
	...
	public class ContainsActual
	{
		 ...
		 */
		@SuppressWarnings("boxing")
		public final ContainsActual allOf(short... elems)
		{
			List<Short> failing = null;
		 ...
		 */
		@SafeVarargs
		public final ContainsActual exactly(short... elems)
		{
		 ...
		 */
		@SuppressWarnings("boxing")
		public final ContainsActual noneOf(short... elems)
		{
			List<Short> failing = null;
			for (short elem : elems)
			{
		 ...
		 * @return this ContainsActual
		 */
		public final ContainsActual someOf(short... elems)
		{
			boolean found = false;
			for (short elem : elems)
			{
	 ...
	 * @return this
	 */
	public IMPL elem(int index, short expected)
	{
	...
	/**
	 * Returns a ShortActual for the element at the given index.
	 * @param index the index
	 * @return the new actual
	 */
	public ShortActual<IMPL,?> elem(int index)
	{
		return new ShortActual<>(getElem(index), self());
	}
	 ...
	 * @return this
	 */
	public IMPL elems(short... expected)
	{
	 ...
	 */
	@NotMustBeOff
	protected short getElem(int index)
	{
		notMustBeOff();
	 ...
	 * @return contained?
	 */
	protected boolean doesContain(short elem)
	{
		for (short e : value())
		{
			if (elem == e)
