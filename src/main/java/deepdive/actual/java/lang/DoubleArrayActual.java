...
/**
 * An Actual implementation for primitive double arrays.
 */
public class DoubleArrayActual<BACK,IMPL extends DoubleArrayActual<BACK,IMPL>> extends Actual<double[],BACK,IMPL> 
{
	/**
	 * Creates a DoubleArrayActual for the given value and owner.
	 * @param value the value
	 * @param back the owner
	 */
	public DoubleArrayActual(double[] value, BACK back)
	{
		super(value, back);
	}
	...
	public IMPL contains(double expected)
	{
	...
	public class ContainsActual
	{
		 ...
		 */
		@SuppressWarnings("boxing")
		public final ContainsActual allOf(double... elems)
		{
			List<Double> failing = null;
		 ...
		 */
		@SafeVarargs
		public final ContainsActual exactly(double... elems)
		{
		 ...
		 */
		@SuppressWarnings("boxing")
		public final ContainsActual noneOf(double... elems)
		{
			List<Double> failing = null;
			for (double elem : elems)
			{
		 ...
		 * @return this ContainsActual
		 */
		public final ContainsActual someOf(double... elems)
		{
			boolean found = false;
			for (double elem : elems)
			{
	 ...
	 * @return this
	 */
	public IMPL elem(int index, double expected, double delta)
	{
	...
	/**
	 * Returns a DoubleActual for the element at the given index.
	 * @param index the index
	 * @return the new actual
	 */
	public DoubleActual<IMPL,?> elem(int index)
	{
		return new DoubleActual<>(getElem(index), self());
	}
	 ...
	 * @return this
	 */
	public IMPL elems(double... expected)
	{
	 ...
	 */
	@NotMustBeOff
	protected double getElem(int index)
	{
		notMustBeOff();
	 ...
	 * @return contained?
	 */
	protected boolean doesContain(double elem)
	{
		for (double e : value())
		{
			if (elem == e)
